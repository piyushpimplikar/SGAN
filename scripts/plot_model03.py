...
def ploot():
    ...
    ani.save("animation_visualize2.gif")
    ...
    with torch.no_grad():
        for batch in loader:
            ...
            for _ in range(1):  # num_samples
                ...
                gt = pred_traj_gt[:, 2, :].data
                input_a = obs_traj[:, 2, :].data
                out_a = pred_traj_fake[:, 2, :].data
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default="models/condor_models/sgan-p/eth-20VP-1-8_with_model.pt", type=str)
